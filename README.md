...
Windows PowerShell:
```powershell
$env:LINGYAAI_API_KEY="你的API密钥"
```

Linux/macOS:
```bash
export LINGYAAI_API_KEY="你的API密钥"
```
...
| 模型名称 | 模型 ID | 适用场景 |
|---------|---------|---------|
| Gemini 3 Flash Preview | `gemini-3-flash-preview` | 快速响应任务 |
| Kimi K2.5 | `kimi-k2.5` | 中文理解任务 |
| Claude Opus 4.6 | `claude-opus-4-6` | 复杂推理任务 |
| 豆包 Seed 2.0 Pro | `doubao-seed-2-0-pro` | 通用任务 |
| Minimax M2.5 | `minimax-m2.5` | 通用任务 |

### 环境变量

| 变量名 | 说明 | 必需 |
|--------|------|------|
| `LINGYAAI_API_KEY` | API 密钥 | ✅ |
...
<p align="center">
  Made with ❤️ by <a href="https://github.com/wubq511">wuboqun</a>
</p>
